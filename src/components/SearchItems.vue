    ...
    <div class="relative">
        <div v-show="!selectedItem">
            ...
            <div class="mt-1 rounded-md shadow-sm">
                <input :id="uniqueLabelId1" v-model="search" class="block w-full p-3 text-gray-300 bg-gray-800 border-2 border-transparent rounded-md focus:border-indigo-600 focus:outline-none" :class="{'rounded-b-none focus:shadow-none': showResults}" :placeholder="placeholder">
            </div>
            <transition
        ...
        <div v-show="selectedItem">
            ...
            <div class="relative mt-1 rounded-md shadow-sm select-none">
                <input :id="uniqueLabelId2" :value="selectedItem" class="block w-full p-3 text-gray-300 bg-gray-700 border-2 border-transparent rounded-md opacity-50 focus:border-indigo-600 focus:outline-none0" disabled>
